...
import dev.rooster.plugin.shell.ShellAllowListMatcher
import dev.rooster.plugin.shell.ShellCommandExecutor
import java.io.File
...
class RunShellCommandTool(private val approver: ShellApprover) : Tool {
    ...
    override suspend fun execute(project: Project, arguments: JsonObject): String {
        ...
        val patterns = RoosterSettings.getInstance().state.shellAllowList
        ...
        val timeout = RoosterSettings.getInstance().state.shellTimeoutSeconds.toLong()
