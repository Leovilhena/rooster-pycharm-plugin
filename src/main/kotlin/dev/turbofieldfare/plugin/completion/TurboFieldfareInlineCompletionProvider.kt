package dev.turbofieldfare.plugin.completion
 ...
 */
class TurboFieldfareInlineCompletionProvider : DebouncedInlineCompletionProvider() {

    override val id = InlineCompletionProviderID("TurboFieldfare")

    override suspend fun getDebounceDelay(request: InlineCompletionRequest): Duration =
        TurboFieldfareSettings.getInstance().state.completionDebounceMs.milliseconds
    ...
    override fun isEnabled(event: InlineCompletionEvent): Boolean {
        val settings = TurboFieldfareSettings.getInstance().state
    ...
    override suspend fun getSuggestionDebounced(request: InlineCompletionRequest): InlineCompletionSuggestion {
        val settings = TurboFieldfareSettings.getInstance()
    ...
    private suspend fun requestCompletion(
        prefix: String,
        suffix: String,
        settings: TurboFieldfareSettings,
    ): String? {
        val client = TurboFieldfareClient(settings.baseUrl())
