 ...
 * application-scoped config directory `TurboFieldfareSettings` already persists
 ...
 *
 * **A trust boundary, and a different one from [dev.turbofieldfare.plugin.tools.ProjectFiles].**
